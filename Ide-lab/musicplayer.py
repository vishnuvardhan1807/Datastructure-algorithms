...
one.pack(fill=X)
two = Label(root, text="Welcome to Sessions player", bg="white",fg="blue")
two.pack(fill=X)
three = Label(root, text="Created By vishnu, madhuri, yasho, Rohan", bg="green",fg="white")
three.pack(fill=X)

topFrame = Frame(root)#definig a Frame
topFrame.pack()
bottomFrame = Frame(root) #Same, definging the next Frame
...
root.screenMessage.set("Welcome, to Sessions Music Player")
